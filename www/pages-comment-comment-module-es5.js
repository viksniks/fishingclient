  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-comment-comment-module"], {
    ...
    function srcAppPagesCommentCommentModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      CommentPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_7__["TranslateModule"], src_app_components_components_module__WEBPACK_IMPORTED_MODULE_8__["ComponentsModule"], src_app_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_9__["PipesModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _comment_routing_module__WEBPACK_IMPORTED_MODULE_5__["CommentPageRoutingModule"]],
    ...
    function srcAppPagesCommentCommentPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var CommentPage = /*#__PURE__*/function () {
        function CommentPage(route, translate, storage, core, Toast, navCtrl, platform, InAppBrowser, ngZone, alertCtrl) {
          var _this = this;
          ...
          this.ngZone = ngZone;
          this.alertCtrl = alertCtrl; // page of posts

          this.page = 1; // get params
          ...
          this.getComments(); // get translate

          translate.get('comments').subscribe(function (trans) {
            return _this.trans = trans;
          }); // setup form comment

          this.formComment = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
        ...
        _createClass(CommentPage, [{
          ...
          value: function ionViewDidEnter() {
            ...
            this.storage.get('login').then(function (login) {
              ...
              if (login) {
                // if user logined
                _this2.needInfo = false;

                _this2.formComment.removeControl('author_name');

                _this2.formComment.removeControl('author_email');
              } else {
                // if Guest
                _this2.needInfo = true; // backup data form

                var data = _this2.formComment.value || {}; // setup form comment if website settings require_name_email when comment

                if (_this2.core.getConfig('require_name_email')) {
                  _this2.formComment.setControl('author_name', new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](data['author_name'], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required));

                  _this2.formComment.setControl('author_email', new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](data['author_email'], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].email])));
                } else {
                  _this2.formComment.setControl('author_name', new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](data['author_name']));

                  _this2.formComment.setControl('author_email', new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](data['author_email'], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].email));
                }
              }
            });
          }
          ...
          value: function facebook() {
            ...
            var isShow;
            var link = 'https://www.facebook.com/plugins/feedback.php?href=' + this.post_data['encode_link'];
            var option = 'location=no,hardwareback=no,zoom=no,hidden=yes,useWideViewPort=no';
            var accept = [link, 'facebook.com/dialog/plugin.optin', 'facebook.com/login.php'];
            var comment = this.InAppBrowser.create(link, '_blank', option);
            this.loading = true;
            comment.on('loadstart').subscribe(function (res) {
              var valid = false;
              accept.forEach(function (url) {
                if (res['url'].indexOf(url) != -1) valid = true;
              });

              if (!valid) {
                var script = {
                  code: 'location.href = "' + link + '";'
                };
                comment.executeScript(script);
              }
            });
            comment.on('loaderror').subscribe(function (res) {
              if (!isShow) {
                comment.close(); // set comment to null, don't show inappbrowser
            ...
            comment.on('loadstop').subscribe(function (res) {
              var code;
              code = 'document.body.style.padding="50px 0";';
              comment.executeScript({
                code: code
              });
                      ...
                      return this.alertCtrl.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            _this4.loading = true;
                            var option = 'hidden=yes';

                            var logout = _this4.InAppBrowser.create('https://graph.facebook.com/', '_blank', option);

                            logout.on('loadstop').subscribe(function () {
                              _this4.ngZone.run(function () {
                                return _this4.loading = false;
                              });

                              var script = {
                                code: 'document.cookie = "c_user=;Path=/;domain=.facebook.com;";'
                              };
          ...
          value: function getComments() {
            ...
            this.core.request('m_comments/' + this.post_id, {
              params: params
            }).subscribe(function (comments) {
              if (refresher) _this5.page = 1;

              if (infiniteScroll) {
                _this5.comments = _this5.comments.concat(comments);
                infiniteScroll.target.complete();
              } else if (_this5.page == 1) _this5.comments = comments;

              if (comments.length > 0) _this5.page++;else _this5.over = true;
              _this5.loaded = true;
          ...
          value: function comment() {
            ...
            if (this.commenting) return; // when click comment button

            this.commenting = true; // prepare request

            var option = {
              method: 'POST'
            };
            var body = Object.assign(this.formComment.value, {
              parent: this.parent,
              post: this.post_id
            });
            option['body'] = body; // request comment

            this.core.request('comments', option, false, true).subscribe(function (res) {
              _this6.commenting = false; // when success

              var data = res;

              _this6.formComment.reset(); // if comment is approved then reload list comments
              ...
              if (data['status'] == 'approved') {
                ...
                _this6.comments.unshift(comment);
              } else _this6.Toast.showLongCenter(_this6.trans['message']['hold']).subscribe(function () {}, function () {});
            }, function (err) {
              // when error
              _this6.commenting = false; // prepare message

              var message;
              if (!_this6.trans['message']) return;
              if (_this6.trans['message'][err['error']['code']]) message = _this6.trans['message'][err['error']['code']];else message = _this6.trans['message']['default']; // show Toast

              _this6.Toast.showLongCenter(message).subscribe(function () {}, function () {}); // if website require for comment and user is Guest


              if (err['error']['code'] == 'rest_comment_login_required') _this6.navCtrl.navigateForward('/login');
            });
          }
        }, {
          key: "viewComment",
          value: function viewComment(comment) {
            ...
            this.navCtrl.navigateForward(['/comment', this.post_id, {
              status: this.status,
              parent: comment['id']
            }]);
          }
      ...
      CommentPage.ctorParameters = function () {
        return [{
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_4__["TranslateService"], _ionic_storage__WEBPACK_IMPORTED_MODULE_5__["Storage"], src_app_services_core_service__WEBPACK_IMPORTED_MODULE_6__["CoreService"], _ionic_native_toast_ngx__WEBPACK_IMPORTED_MODULE_7__["Toast"], _ionic_angular__WEBPACK_IMPORTED_MODULE_8__["NavController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_8__["Platform"], _ionic_native_in_app_browser_ngx__WEBPACK_IMPORTED_MODULE_9__["InAppBrowser"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"], _ionic_angular__WEBPACK_IMPORTED_MODULE_8__["AlertController"]])], CommentPage);
      /***/
    }
  }]);
})();
