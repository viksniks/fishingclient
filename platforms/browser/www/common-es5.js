(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    function srcAppPagesNotificationsNotificationsPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_services_core_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! src/app/services/core.service */
      "./src/app/services/core.service.ts");
      /* harmony import */


      var src_app_services_deeplinks_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      var NotificationsPage = /*#__PURE__*/function () {
        function NotificationsPage(translate, storage, core, deeplinks, alertCtrl) {
          var _this = this;
          ...
          this.alertCtrl = alertCtrl; // get translate

          translate.get('notification').subscribe(function (trans) {
        ...
        _createClass(NotificationsPage, [{
          ...
          value: function ionViewDidEnter() {
            ...
            this.updateNotifications(); // check clicked or not

            var clicked = this.core.getState('clicked_notification');
          ...
          value: function updateNotifications() {
            ...
            return new Promise(function (resolve) {
              _this2.storage.get('notifications').then(function (notifications) {
          ...
          key: "launch",
          value: function launch(notification) {
            this.runDeeplinks(notification, true);
          }
        }, {
          key: "runDeeplinks",
          value: function runDeeplinks(notification) {
            var _this3 = this;

            var isLaunch = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
            ...
            if (!link) return;
            this.loading = true;
            this.core.request('m_tools/deeplinks', {
              params: {
              ...
              _this3.deeplinks.run(res, null, link);
            }, function (err) {
                      ...
                      return this.alertCtrl.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            ...
                            _this4.notifications.splice(_this4.notifications.indexOf(notification), 1);

                            _this4.storage.set('notifications', _this4.notifications);
                          }
                        }, {
                    ...
                    case 0:
                      ...
                      return this.alertCtrl.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            _this5.storage.remove('notifications').then(function () {
                              _this5.notifications = null;
                            });
                          }
                        }, {
      ...
      NotificationsPage.ctorParameters = function () {
        return [{
          ...
          type: src_app_services_core_service__WEBPACK_IMPORTED_MODULE_4__["CoreService"]
        }, {
          type: src_app_services_deeplinks_service__WEBPACK_IMPORTED_MODULE_5__["DeeplinksService"]
        }, {
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"], _ionic_storage__WEBPACK_IMPORTED_MODULE_3__["Storage"], src_app_services_core_service__WEBPACK_IMPORTED_MODULE_4__["CoreService"], src_app_services_deeplinks_service__WEBPACK_IMPORTED_MODULE_5__["DeeplinksService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["AlertController"]])], NotificationsPage);
      /***/
    }
  }]);
})();
